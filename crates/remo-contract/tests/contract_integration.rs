//! Integration tests verifying cross-module contract compatibility in remo-contract.

use remo_contract::contract::content::ContentBlock;
use remo_contract::contract::event::AgentEvent;
use remo_contract::contract::inference::{
...
use remo_contract::contract::lifecycle::TerminationReason;
use remo_contract::contract::message::{Message, MessageMetadata, Role, ToolCall, Visibility};
use remo_contract::contract::storage::{
    MessageQuery, MessageSeqRange, RunMessageInput, RunMessageOutput, RunPage, RunQuery, RunRecord,
    StorageError,
};
use remo_contract::contract::suspension::ToolCallOutcome;
use remo_contract::contract::tool::{ToolDescriptor, ToolError, ToolResult};
use serde_json::json;
...
fn run_record_roundtrip_preserves_all_fields() {
    use remo_contract::contract::lifecycle::RunStatus;
...
fn all_termination_reasons_serialize_in_run_finish() {
    use remo_contract::contract::lifecycle::StoppedReason;
