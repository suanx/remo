...
use remo_ext_reminder::ReminderRulesConfig;
use remo_ext_reminder::output_matcher::{
    ContentMatcher, OutputMatcher, ToolStatusMatcher, output_matches,
};
use remo_ext_reminder::plugin::ReminderPlugin;
use remo_ext_reminder::rule::ReminderRule;
use remo_runtime_contract::contract::context_message::ContextMessage;
use remo_runtime_contract::contract::tool::ToolResult;
use remo_tool_pattern::{
...
fn plugin_has_correct_name() {
    ...
    assert_eq!(
        ...
        remo_ext_reminder::plugin::REMINDER_PLUGIN_NAME
    );
}
...
fn reminder_produces_correct_context_message() {
    ...
    assert_eq!(
        rule.message.target,
        remo_runtime_contract::contract::context_message::ContextMessageTarget::SuffixSystem
    );
