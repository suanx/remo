...
use remo::contract::event_sink::NullEventSink;
...
use remo::contract::inference::{StopReason, StreamResult, TokenUsage};
...
use remo::ext_observability::{InMemorySink, ObservabilityPlugin};
...
async fn observability_captures_single_inference_e2e() {
    ...
    let event_sink: Arc<dyn remo::contract::event_sink::EventSink> = Arc::new(NullEventSink);
