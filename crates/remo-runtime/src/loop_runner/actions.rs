...
pub(super) fn merge_override_payloads(
    base: &mut Option<remo_runtime_contract::contract::inference::InferenceOverride>,
    payloads: Vec<remo_runtime_contract::contract::inference::InferenceOverride>,
) {
    for ovr in payloads {
...
pub(super) fn apply_tool_filter_payloads(
    tools: &mut Vec<remo_runtime_contract::contract::tool::ToolDescriptor>,
...
pub(super) fn resolve_intercept_payloads(
    payloads: Vec<remo_runtime_contract::contract::tool_intercept::ToolInterceptPayload>,
...
pub(super) fn apply_context_messages(
    ...
    use remo_runtime_contract::contract::context_message::ContextMessageTarget;
    ...
    for entry in context_messages {
        let msg = Message {
            id: Some(remo_runtime_contract::contract::message::gen_message_id()),
            role: entry.role,
