...
use remo_runtime_contract::contract::suspension::ToolCallOutcome;
use remo_runtime_contract::contract::tool::{Tool, ToolCallContext, ToolOutput, ToolResult};
...
pub trait ToolExecutionLocus: Send + Sync {
    async fn execute_tool(
        ...
        call: &ToolCall,
        ctx: &ToolCallContext,
    ) -> Result<ToolOutput, remo_runtime_contract::contract::tool::ToolError>;
...
mod tests {
    use super::*;
    use remo_runtime_contract::contract::tool::{ToolDescriptor, ToolError, ToolOutput};
