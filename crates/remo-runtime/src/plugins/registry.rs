...
use remo_runtime_contract::model::{EffectSpec, JsonValue, Phase, ScheduledActionSpec};
...
pub(crate) type RequestTransformArc =
    std::sync::Arc<dyn remo_runtime_contract::contract::transform::InferenceRequestTransform>;
...
impl PluginRegistrar {
    ...
    where
        T: remo_runtime_contract::contract::transform::InferenceRequestTransform + 'static,
    {
