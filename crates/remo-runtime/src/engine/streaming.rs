...
use remo_runtime_contract::contract::executor::InterruptSnapshot;
use remo_runtime_contract::contract::inference::{StreamResult, TokenUsage};
...
pub struct StreamCollector {
    ...
    stop_reason: Option<remo_runtime_contract::contract::inference::StopReason>,
...
impl StreamCollector {
    ...
    pub fn finish(self) -> StreamResult {
        ...
        let content = if self.text.is_empty() {
            ...
            vec![remo_runtime_contract::contract::content::ContentBlock::text(self.text)]
        };
...
mod tests {
    ...
    fn collector_handles_stop_event() {
        ...
        assert_eq!(
            result.stop_reason,
            Some(remo_runtime_contract::contract::inference::StopReason::EndTurn)
        );
    }
